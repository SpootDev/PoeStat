...
The CurrencyPostprocessor class knows everything about transforming
...
class CurrencyPostprocessor:
    ...
    # This is a performance tuning parameter. Integer number of minutes
    recent = None
    ...
    def parse_note(self, note, regex=None):
        ...
        to return None if there was no valid price.
        """
