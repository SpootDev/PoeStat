...
def com_search_stash(db_dataset, shaper_item=False, eldar_item=False,
    ...
    returned_items = []
    print(shaper_item, eldar_item, veiled_item, corrupt_item, is_usable, fractured_item,
          synthesized_item, number_of_sockets, number_of_links, armor_points,
          es_points, evasion_points, minimum_ilvl,
